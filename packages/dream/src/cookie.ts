// Taken from: https://github.com/remix-run/remix/blob/main/packages/remix-server-runtime/cookies.ts
...
export function warnOnceAboutExpiresCookie(name: string, expires?: Date) {
	warnOnce(
		!expires,
